...
function SortArray(x, y){
  return x.last.localeCompare(y.last); //localCompare compare x et y entre eux et les classe par ordre alphabetique visiblement
}
